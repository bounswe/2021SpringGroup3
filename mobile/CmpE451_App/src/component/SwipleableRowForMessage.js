    ...
    return (
      <Animated.View
        ...
        <View style={styles.totalaction}>
          <RectButton
            style={[styles.leftAction, {backgroundColor: '#FFFFFF'}]}
            ...
            <Text style={styles.actionText}>Sessize al</Text>
          </RectButton>
          <View
            style={{height: 50, width: 1.5, backgroundColor: '#c3c3c5'}}></View>
          <RectButton
            ...
            <Ionicons
              ...
              color={'red'}
            />
            <Text style={styles.actionText}>Mesajlaşmayı sil</Text>
          </RectButton>
        </View>
      </Animated.View>
    );
